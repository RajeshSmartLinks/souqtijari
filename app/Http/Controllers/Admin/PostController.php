...
class PostController extends Controller
{
    ...
    {
        $titles = ['title' => 'Manage News', 'subTitle' => 'News List'];
        $deleteRouteName = "post.destroy";

        $posts = Post::whereType('post')->get();

        return view('admin.posts.list', compact('titles', 'deleteRouteName', 'posts'));
    }
    ...
    {
        $titles = ['title' => 'Manage News', 'subTitle' => 'Add News'];

        return view('admin.posts.create', compact('titles'));
    }
    ...
    {
        $titles = ['title' => 'Manage News', 'subTitle' => 'News Edit'];
        $deleteRouteName = "post.destroy";

        $editPost = Post::find($id);

        return view('admin.posts.edit', compact('titles', 'editPost'));
    }
