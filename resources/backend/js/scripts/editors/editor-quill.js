...
(function (window, document, $) {
    ...
    var snowEditor2 = new Quill('#snow-container .editor', {
        bounds: '#snow-container2 .editor2',
        modules: {
            'formula': true,
            'syntax': true,
            'toolbar': '#snow-container2 .quill-toolbar'
        },
        theme: 'snow'
    });
    ...
    var fullEditorAr = new Quill('#full-containerar .editorar', {
        bounds: '#full-container .editor',
        modules: {
            'formula': true,
            'syntax': true,
    ...
    var editors = [bubbleEditor, snowEditor, fullEditor, fullEditorAr];
