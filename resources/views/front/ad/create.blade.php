    ...
    <div class="row ">
      <div class="col-lg-8 col-md-12 col-md-12">
        <div class="card ">
		  ...
		  <form action="{{route('adcreate', app()->getLocale())}}" method="post" name="adform" id="adform" enctype="multipart/form-data">
			  @csrf
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="ad_title" id="ad_title" placeholder="@lang('app.ad_title')" maxlength="40" required>
            ...
            <div class="form-group">
              ...
              <div class="d-md-flex ad-post-details">
                <label class="custom-control custom-radio mb-2 {{app()->getLocale() == 'en' ? 'mr' : 'ml'}}-4">
                  <input type="radio" class="custom-control-input" name="ad_condition" id="ad_condition" value="new" checked="">
                  <span class="custom-control-label"><a href="#" class="text-muted">@lang('app.new') </a></span> </label>
                <label class="custom-control custom-radio  mb-2">
                  <input type="radio" class="custom-control-input" name="ad_condition" id="ad_condition" value="used" >
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="@lang('app.price_value')" name="ad_price" id="ad_price" required>
            </div>
            <div class="form-group">
              <label class="form-label text-dark">@lang('app.negotiable')</label>
              <label class="custom-control custom-checkbox mb-3">
				<input type="checkbox" class="custom-control-input" value="1" name="ad_is_negotiable" id="ad_is_negotiable">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="ad_seller_name" id="ad_seller_name" value="{{ $data['user_seller_name'] }}" placeholder="@lang('app.seller_name')" required>
            </div>
            <div class="form-group">
              <label class="form-label text-dark">@lang('app.seller_email')</label>
              <input type="text" class="form-control" name="ad_seller_email" id="ad_seller_email" value="{{ $data['user_seller_email'] }}" placeholder="@lang('app.seller_email')">
            </div>
            <div class="form-group">
              <label class="form-label text-dark">@lang('app.seller_phone')</label>
              <input type="text" class="form-control" name="ad_seller_phone" id="ad_seller_phone" value="{{ $data['user_seller_mobile'] }}" placeholder="@lang('app.seller_phone')" required>
            </div>
            <div class="form-group">
              <label class="form-label text-dark"></label>
              <label class="custom-control custom-checkbox mb-3">				
              <input type="checkbox" class="custom-control-input" name="ad_phone_whatsapp" id="ad_phone_whatsapp" {{ $data['user_seller_mobile']==$data['user_seller_whatsapp'] ? 'checked' : '' }} >
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="ad_seller_whatsapp" id="ad_seller_whatsapp" value="{{ $data['user_seller_whatsapp'] }}" placeholder="@lang('app.seller_whatsapp')">
            </div>
            <div class="form-group">
              <label class="form-label text-dark">@lang('app.seller_address')</label>
              <textarea class="form-control" name="ad_seller_address" id="ad_seller_address" rows="6" placeholder="@lang('app.seller_address')">{{ $data['user_seller_address'] }}</textarea>
            </div>
            <div class="form-group">
